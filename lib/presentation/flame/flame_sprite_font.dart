...
class FlameSpriteFont extends SpriteFont {
  ...
  FlameSpriteFont(String fileName, double w, double h, int cols, int rows, {SpriteFontType type=SpriteFontType.CHARACTER}) {
  ...
  Sprite getSprite(String char) {
    ...
    return FlameSprite(_spriteSheet.getSprite(0, offset))..anchor = AnchorPoint.BOTTOM_LEFT;
  }
